...
| --- | --- | --- |
| Vercel | Project selection/creation, env wiring, deployment and supported domain attachment | Vercel + Supabase passed disposable E2E. Vercel CLI is required even with token fallback. |
...
## Additional adapters: live validation pending
...
| DNS | Cloudflare, GoDaddy, Porkbun | Records in an existing authoritative zone; no domain purchase, renewal, transfer or nameserver changes |
